...
- does not bind `Device_List`, `Device_Open_WithClass`, `Device_InitIFAGC`, `Device_SetIFAGCTarget`, `Device_GetAmpAttenState`, `RTA_GetRealTimeSpectrum_Raw`, or other newer functions;
